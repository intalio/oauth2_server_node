...
exports.connector = function(config, Model, authentication, forget_password) {
 ...
 console.log(util.inspect(config, false, 1));
  return router(function(app) {
    ...
    app.post(config.process_forget_url, forget_password.process_forget);
    app.get(config.reset_password_url, forget_password.reset_password);
    app.post(config.process_reset_password_url, forget_password.process_reset_password);
    app.post(config.regist_new_user_url, forget_password.regist_new_user);
    app.get(config.authorize_new_user_url, forget_password.authorize_new_user);
  });
};
